...
const CARDS = [
  ...
  { icon: Icons.ClipboardCheck, label: 'Apply Workflow',       desc: 'Apply workflow templates to projects',      page: 'applyworkflow' },
  { icon: Icons.ClipboardCheck, label: 'Review Workflows',     desc: 'Review and approve workflow submissions',   page: 'reviewworkflow' },
];
